...
export const IntentSchema = z.object({
  ...
  professionalId: z.number().nullable().describe('ID of the medical professional'),
  professionalName: z.string().nullable().describe('Name of the medical professional'),
  datetime: z.string().nullable().describe('Appointment date and time in ISO format'),
  patientName: z.string().nullable().describe('Patient name extracted from question'),
  reason: z.string().nullable().describe('Reason for appointment (for scheduling)'),
});
